...
Reusable manual test scenarios for AI agents validating `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php`.
...
1. `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php`
2. `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php start --help`
3. `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php review-request --help`
4. `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php help`
5. `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php help start`
...
- `help start` returns the same unknown-command error (no silent fallback)
...
1. `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php list --stage=todo`
2. Write `[scenario-todo-end] Test inserted at end` to `local/tests/test-scenario-todo-end.md`, then:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php entry-create --body-file=local/tests/test-scenario-todo-end.md`
3. Write `[scenario-todo-start] Test inserted at start` to `local/tests/test-scenario-todo-start.md`, then:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php entry-create --body-file=local/tests/test-scenario-todo-start.md --position=start`
4. Write `[scenario-todo-index] Test inserted at index` to `local/tests/test-scenario-todo-index.md`, then:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php entry-create --body-file=local/tests/test-scenario-todo-index.md --position=index --index=2`
5. Write `[scenario-feature][scenario-task] Stable ref task` to `local/tests/test-scenario-feature-task.md`, then:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php entry-create --body-file=local/tests/test-scenario-feature-task.md`
6. `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php list --stage=todo`
7. Remove one inserted task by its stable reference shown in `list --stage=todo`:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php entry-remove scenario-todo-index`
...
- the scoped entry `[scenario-feature][scenario-task] Stable ref task` is printed as `N. [scenario-feature/scenario-task] Stable ref task` and is usable as the start target
- removing a queued task by reference updates only the todo section
- `entry-remove` refuses an empty, unknown, or ambiguous reference and never accepts display numbers as identity
...
Validate `start` on a plain queued task.
...
1. Create the plain test task — write `[feat][test-plain-feature-alpha] test-plain-feature-alpha` to `local/tests/test-plain-feature-alpha.md`, then:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php entry-create --body-file=local/tests/test-plain-feature-alpha.md`
2. Confirm next plain task with:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php list --stage=todo`
3. Start it:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php start`
4. Inspect result:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php list`
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php status --agent d01`
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php worktree-list`
...
- `start` output includes the feature summary and assigned worktree
...
Validate `start <entry-ref>` consumes the named queued entry instead of the head, and refuses with a clear error when the target does not match.

### Steps

1. Create two prefixed queued tasks — write each body to `local/tests/`, then:
   - Write `[ws-head] Head entry that should stay queued` to `local/tests/test-ws-head.md`, then: `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php entry-create --body-file=local/tests/test-ws-head.md`
   - Write `[ws-target] Explicit target entry` to `local/tests/test-ws-target.md`, then: `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php entry-create --body-file=local/tests/test-ws-target.md`
...
3. Try a target that does not match any queued entry:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php start unknown-slug`
4. Start the second entry by explicit reference:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php start ws-target`
...
Validate the single-prefix `[feature-slug] text` mode of `start` and the `rename` command on a feature and a task.
...
1. Create a single-prefix task — write `[feat][test-single-prefix] Single prefix feature description` to `local/tests/test-single-prefix.md`, then:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php entry-create --body-file=local/tests/test-single-prefix.md`
2. Start it:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php start`
3. Rename the active feature entry:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php rename "Renamed single prefix description"`
4. Inspect:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php status test-single-prefix`
5. Release the feature:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php release test-single-prefix`
6. Create a scoped task to test rename on a `kind=task` — write `[feat][test-scoped-feature][rename-task] Original task text` to `local/tests/test-scoped-rename-task.md`, then:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php entry-create --body-file=local/tests/test-scoped-rename-task.md`
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php start`
7. Rename the active task entry:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php rename "Renamed task text"`
8. Inspect both the task and the parent feature container:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php status --agent d01`
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php status test-scoped-feature`

### Expected checks

- `start` on `[test-single-prefix] ...` creates a `kind=feature` with slug `test-single-prefix`, not a slug derived from the description
- after `rename`, `status test-single-prefix` shows `Summary: Renamed single prefix description`
...
Validate `release` on a feature with no actual development ahead of base.

### Steps

1. Release the active feature:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php release`
2. Inspect:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php list --stage=todo`
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php list`
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php worktree-list`
...
1. Create the assignment test task — write `[feat][test-assign-feature] test-assign-feature` to `local/tests/test-assign-feature.md`, then:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php entry-create --body-file=local/tests/test-assign-feature.md`
2. Start it:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php start`
3. Refresh the same assignment:
   - `SOMANAGER_ROLE=manager SOMANAGER_AGENT=m01 php scripts/backlog/backlog.php assign test-assign-feature --agent d01`
4. Try to assign to another agent while the entry is already assigned:
   - `SOMANAGER_ROLE=manager SOMANAGER_AGENT=m01 php scripts/backlog/backlog.php assign test-assign-feature --agent d02`
5. Unassign it with manager role:
   - `SOMANAGER_ROLE=manager SOMANAGER_AGENT=m01 php scripts/backlog/backlog.php unassign test-assign-feature --agent m01`
6. Assign the unassigned entry with manager role:
   - `SOMANAGER_ROLE=manager SOMANAGER_AGENT=m01 php scripts/backlog/backlog.php assign test-assign-feature --agent d02`
7. Inspect:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php status --agent d02`
8. Unassign with manager role:
   - `SOMANAGER_ROLE=manager SOMANAGER_AGENT=m01 php scripts/backlog/backlog.php unassign test-assign-feature --agent m01`
9. Unassign a child task with manager role using `<entry-ref>`:
   - `SOMANAGER_ROLE=manager SOMANAGER_AGENT=m01 php scripts/backlog/backlog.php unassign test-assign-feature/cleanup --agent m01`
10. Unassign the caller agent's single active entry without an explicit reference:
   - `SOMANAGER_ROLE=manager SOMANAGER_AGENT=m01 php scripts/backlog/backlog.php unassign --agent d02`
...
Validate `start` on scoped queued tasks.
...
1. Create the first scoped child task — write `[feat][test-scoped-feature][test-child-a] Implement test child task A` to `local/tests/test-child-a.md`, then:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php entry-create --body-file=local/tests/test-child-a.md`
...
- `start` output includes the child task, parent feature, and assigned worktree
...
2. Inspect the review queue and claim the task by explicit reference:
   - `SOMANAGER_ROLE=reviewer SOMANAGER_AGENT=r01 php scripts/backlog/backlog.php list --stage=review`
   - `SOMANAGER_ROLE=reviewer SOMANAGER_AGENT=r01 php scripts/backlog/backlog.php review-next test-scoped-feature/test-child-a`
3. Run the mechanical check:
   - `SOMANAGER_ROLE=reviewer SOMANAGER_AGENT=r01 php scripts/backlog/backlog.php review-check test-scoped-feature/test-child-a`
4. Reject it:
   - create a local review body under `local/tests/`
   - `SOMANAGER_ROLE=reviewer SOMANAGER_AGENT=r01 php scripts/backlog/backlog.php review-reject test-scoped-feature/test-child-a --body-file local/tests/test-task-review-reject.md`
5. Inspect the stored review notes through the protected, read-only block (without mutating state):
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php review-notes test-scoped-feature/test-child-a`
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php review-notes --agent d01`
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php status --agent d01`
6. Rework and resubmit:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php rework test-scoped-feature/test-child-a`
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php review-request`
7. Approve:
   - `SOMANAGER_ROLE=reviewer SOMANAGER_AGENT=r01 php scripts/backlog/backlog.php review-approve test-scoped-feature/test-child-a`
...
- `SOMANAGER_ROLE=reviewer SOMANAGER_AGENT=r01 php scripts/backlog/backlog.php review-next test-scoped-feature/test-child-a` claims the named entry, moves it to `reviewing`, and refuses with `is already in Reviewing` when any other reviewer targets it before review-cancel runs
...
1. Before merging, inspect the active task entry directly:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php status test-scoped-feature/test-child-a`
2. Verify `list` shows the task with full reference and kind indicator:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php list`
3. Merge the approved task:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php merge test-scoped-feature/test-child-a`
4. Inspect:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php status test-scoped-feature`
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php list`
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php worktree-list`
...
Validate that after merging task A, `start` picks up the next queued scoped task and the full review cycle repeats for task B.
...
1. Create the second scoped child task — write `[feat][test-scoped-feature][test-child-b] Implement test child task B` to `local/tests/test-child-b.md`, then:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php entry-create --body-file=local/tests/test-child-b.md`
2. Confirm the developer has no active entry (parent feature has `developer=none` after task A merge):
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php status --agent d01`
3. Pick up task B (`start` allows this since d01 has no active entry):
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php start`
4. Inspect:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php status test-scoped-feature`
5. Submit, review, and approve task B (same cycle as Scenario 8):
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php review-request`
   - `SOMANAGER_ROLE=reviewer SOMANAGER_AGENT=r01 php scripts/backlog/backlog.php review-approve test-scoped-feature/test-child-b`
6. Merge task B:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php merge test-scoped-feature/test-child-b`
...
- after step 6, agent d01 has no active entry; take ownership with `assign` before `review-request`
...
1. Developer takes integration ownership of the feature:
   - `SOMANAGER_ROLE=manager SOMANAGER_AGENT=m01 php scripts/backlog/backlog.php assign --agent d01 test-scoped-feature`
2. Submit the feature for review:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php review-request`
3. Inspect:
   - `SOMANAGER_ROLE=reviewer SOMANAGER_AGENT=r01 php scripts/backlog/backlog.php review-next`
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php status test-scoped-feature`
4. Run mechanical check:
   - `SOMANAGER_ROLE=reviewer SOMANAGER_AGENT=r01 php scripts/backlog/backlog.php review-check test-scoped-feature`
5. Reject:
   - `SOMANAGER_ROLE=reviewer SOMANAGER_AGENT=r01 php scripts/backlog/backlog.php review-reject test-scoped-feature --body-file local/tests/test-feature-review-reject.md`
5.a Inspect the stored feature review notes through the protected, read-only block:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php review-notes test-scoped-feature`
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php review-notes --agent d01`
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php status --agent d01`
6. Rework and resubmit:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php rework test-scoped-feature`
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php review-request`
7. Approve:
   - `SOMANAGER_ROLE=reviewer SOMANAGER_AGENT=r01 php scripts/backlog/backlog.php review-approve test-scoped-feature`
...
1. Block:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php feature-block test-scoped-feature`
2. Inspect:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php status test-scoped-feature`
3. Unblock:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php feature-unblock test-scoped-feature`
4. Inspect again.
...
1. Create a dedicated closable fix feature — write `[fix][test-fix-feature-beta] test-fix-feature-beta` to `local/tests/test-fix-feature-beta.md`, then:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php entry-create --body-file=local/tests/test-fix-feature-beta.md`
2. Start it:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d02 php scripts/backlog/backlog.php start`
3. Close the unmerged feature when the workflow requires closing:
   - `SOMANAGER_ROLE=reviewer SOMANAGER_AGENT=r01 php scripts/backlog/backlog.php feature-close test-fix-feature-beta`
4. For the approved scoped feature, merge it:
   - `SOMANAGER_ROLE=reviewer SOMANAGER_AGENT=r01 php scripts/backlog/backlog.php merge test-scoped-feature`
5. Inspect:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php list`
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php worktree-list`
...
1. `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php worktree-list`
2. `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php worktree-clean --dry-run`
3. `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php worktree-clean`
4. `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php worktree-list`
...
12. Call `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php --unknown-global` and confirm it fails with `Unknown global option(s): --unknown-global`.
...
1. `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php entry-set-meta my-feature database=d01_migrate_gen`
   — sets the key on the entry identified by `my-feature`
2. `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php status --agent=d01`
   — `database: d01_migrate_gen` must appear in the meta block
3. `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php entry-set-meta my-feature database=d01_migrate_gen_v2`
   — overwrites the key
4. `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php status --agent=d01`
   — `database: d01_migrate_gen_v2` must be present; `d01_migrate_gen` must be gone
5. `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php entry-set-meta my-feature database=`
   — clears the key (empty value)
6. `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php status --agent=d01`
   — no `database:` line in the meta block
7. `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php entry-set-meta my-feature unknown-key=value`
   — must fail with `does not support key "unknown-key"`
8. `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php entry-set-meta my-feature database`
   — must fail with `key=value argument`
9. `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php entry-set-meta database=some_db`
   — must fail with `<entry-ref> argument` (no entry-ref provided)
10. `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php entry-set-meta does-not-exist database=some_db`
...
1. `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php`
2. `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php start --help`
3. `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php list --stage=todo`
4. `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php list`
5. `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php worktree-list`
6. `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog/backlog.php status --agent <known-agent>`
