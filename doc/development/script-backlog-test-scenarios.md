...
2. `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog.php task-create "[scenario-todo-end] Test inserted at end"`
3. `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog.php task-create --position=start "[scenario-todo-start] Test inserted at start"`
4. `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog.php task-create --position=index --index=2 "[scenario-todo-index] Test inserted at index"`
5. `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog.php task-create '[scenario-feature][scenario-task] Stable ref task'`
...
1. Create the plain test task:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog.php task-create test-plain-feature-alpha`
...
1. Create two prefixed queued tasks:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog.php task-create '[ws-head] Head entry that should stay queued'`
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog.php task-create '[ws-target] Explicit target entry'`
...
1. Create a single-prefix task:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog.php task-create "[test-single-prefix] Single prefix feature description"`
2. Start it:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog.php work-start`
...
6. Create a scoped task to test entry-rename on a `kind=task`:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog.php task-create "[test-scoped-feature][rename-task] Original task text"`
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog.php work-start`
...
1. Create the assignment test task:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog.php task-create test-assign-feature`
2. Start it:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog.php work-start`
...
1. Create the first scoped child task:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog.php task-create [test-scoped-feature][test-child-a] Implement test child task A`
...
1. Create the second scoped child task:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog.php task-create [test-scoped-feature][test-child-b] Implement test child task B`
...
1. Create a dedicated closable fix feature:
   - `SOMANAGER_ROLE=developer SOMANAGER_AGENT=d01 php scripts/backlog.php task-create [fix] test-fix-feature-beta`
2. Start it:
