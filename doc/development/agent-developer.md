...
- Forbidden for `Developer`: `php scripts/console.php`, `php scripts/node.php`, `php scripts/db.php`, `php scripts/toolkit/server.php`, `php scripts/health.php`, `php scripts/toolkit/github.php`, and any script that talks to containers, runtime, database, network, or GitHub.
