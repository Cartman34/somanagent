...
- prefer `php scripts/toolkit/console.php cache:clear` over `docker exec ... bin/console cache:clear`
...
- prefer `php scripts/toolkit/db.php query "SELECT ..."` over a repeated `docker exec ... psql -c "SELECT ..."`
