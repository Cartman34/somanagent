...
// Usage: php scripts/tests/test-backlog-workflow.php --allow-remote --campaign feature-review-lifecycle

require_once __DIR__ . '/../src/bootstrap.php';

use Sowapps\SoManAgent\Script\Runner\TestBacklogWorkflowRunner;
